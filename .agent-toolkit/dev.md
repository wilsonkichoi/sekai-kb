...
test_command: "npm run version:check && npm run genericity && npm run worker-config:check && npm run worker-config:selftest && npm run schema-docs && npm run framework-docs && npm run framework-docs:selftest && npm run corpus-refresh:check && npm run corpus-refresh:selftest && npm run test:corpus-refresh && npm run dev-plugin:check && npm run test:ci && npm run test:snippet && npm run test:soundscape && npm run test:workers && npm run test:embeddings && npm run test:chat && npm run test:mcp && npm run test:ai && npm run test:qr && npm run article-health:test && npm run article-health -- --all --profile=ci-deploy && npm run build && npm run test:theme"
